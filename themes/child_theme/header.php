...
<div class="container">
  <div class="row">
    ...
    <div  class="logo col-lg-2 col-md-2 col-sm-4 col-xs-6">
      <a href="/">
        <img src="<?php echo site_url(); ?>/wp-content/themes/child_theme/img/ISALogo_Rev2c.png" class="img-responsive">
      </a>
    </div>
    <div  class="logo col-lg-2 col-md-2 col-sm-4 col-xs-6">
      <a href="/">
        <img src="<?php echo site_url(); ?>/wp-content/themes/child_theme/img/ICMC_White.png" class="img-responsive">
      </a>
    </div>
